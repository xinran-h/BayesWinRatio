...
update_theta <- function(N_iter, dd, n, m0, L0, S0, v0, time_max) {
    .Call(`_BayesWinRatio_update_theta`, N_iter, dd, n, m0, L0, S0, v0, time_max)
}
...
update_theta_univariate <- function(N_iter, dd, n, L0, m0, v0, S0, time_max) {
    .Call(`_BayesWinRatio_update_theta_univariate`, N_iter, dd, n, L0, m0, v0, S0, time_max)
}
...
compare <- function(M_iter, n_current_ctrl, n_current_trt, postData, time_trt, time_ctrl, surv_trt, surv_ctrl) {
    .Call(`_BayesWinRatio_compare`, M_iter, n_current_ctrl, n_current_trt, postData, time_trt, time_ctrl, surv_trt, surv_ctrl)
}
